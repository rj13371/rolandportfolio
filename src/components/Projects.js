      ...
      <Row>
        ...
        <Col md={6}>
          <Card style={{ maxWidth: '640px', maxHeight: '700px', minWidth: '372px', minHeight: '184px' }} border="light" >
            ...
            <Card.Body>
              <Card.Title><a aria-label="website link for FIN project" href='https://100cn6kcivad9aivblkmlsb5v93taitcnuua6mc74e9sgcm4v61tvjg.siasky.net/' > <h3>  <b> FIN - Financially Intelligent NFTs</b>{' '} {' '} </h3>  </a>
        ...
        <Col md={6}>
          <Card style={{ maxWidth: '640px', maxHeight: '700px', minWidth: '372px', minHeight: '174px' }} border="light" >
            ...
            <Card.Body>
              <Card.Title> <a aria-label="website link for Bastion Games e commerce website project" href='https://mtgwebstore.herokuapp.com/' ><h3>  <b> Bastion Games E Commerce Website </b> {' '}<br /> </h3> </a>
      ...
      <Row>
        <Col md={6}>
          <Card style={{ maxWidth: '640px', maxHeight: '700px', minWidth: '372px', minHeight: '174px' }} border="light" >
            ...
            <Card.Body>
              <Card.Title> <a aria-label="website link for irezumi hub express app project" href='https://irezumi-hub.herokuapp.com/tattooShops' >  <h3> <b> Irezumi Hub </b> {' '}<br /> </h3> </a>
