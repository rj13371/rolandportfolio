...
export default function Text(props) {
  ...
  return (
    ...
    >
      ...
      <Card.Body>
        {language === "jp"
          ? "2021年4月から独学でフルスタックJavaScript開発者として勉強して、現在MERN技術スタックを学んでいます。2021年1月、政治学の学士号を取得して卒業しましたが、ソフトウェアエンジニアとしてのキャリアを追求したいと考え、ソフトウェア開発を学ぶことにしました。趣味は、旅行、トランプゲーム、80年代の日本のポップヒット曲を聴くのが好きです。"
        ...
        <br />
        <a href="https://broken-sun-5506.on.fleek.co/">
          {" "}
          {language === "jp" ? "ポートフォリオv2" : "Portfolio v2"}{" "}
        </a>
      </Card.Body>
    </Card>
  );
