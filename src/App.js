...
<VisibilityComponent children={<Fragment> <h1  style={{
    padding:'100px'
  }} >{t('Hello👋, my name is Roland Matheson')}  <br/> <Socials/> </h1> <Image style={profile ? null : { display: 'none' }} alt='profile picture of Roland' style={{width:'200px'}} src={profile} roundedCircle/> </Fragment>} />
